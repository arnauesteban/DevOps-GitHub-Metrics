...
-- Listage de la structure de table githubmetrics. githubmetricsdata
DROP TABLE IF EXISTS `githubmetricsdata`;
CREATE TABLE IF NOT EXISTS `githubmetricsdata` (
  `Colonne 1` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;

-- Listage des données de la table githubmetrics.githubmetricsdata : ~0 rows (environ)
